# 1. TEMPAT MENYIMPAN DATA (List di dalam List)
# Indeks 0 adalah Nama, Indeks 1 adalah Nilai
data_mahasiswa = [
    ["Ahmad", 85],
    ["Budi", 78],
    ["Citra", 90]
...
# 2. PERULANGAN SUPAYA MENU TERUS MUNCUL
while True:
    print("\n====================================")
    ...
    # Meminta input dari user (.strip() digunakan agar spasi liar tidak bikin error)
    ...
    if pilihan == "1":
        ...
        # Jika panjang data adalah 0, berarti kosong
    ...
    # ----------------------------------------------------
        ...
        nilai_baru = int(input("Masukkan nilai mahasiswa: ")) # int() untuk mengubah teks jadi angka
        
        # Bikin list kecil baru, lalu masukkan ke list utama pakai .append()
    ...
    # ----------------------------------------------------
        ...
        ketemu = False
        for mhs in data_mahasiswa:
            # .lower() digunakan agar tulisan huruf besar/kecil dianggap sama
            if mhs[0].lower() == nama_cari.lower():
                nilai_baru = int(input("Masukkan nilai baru untuk " + mhs[0] + ": "))
                mhs[1] = nilai_baru # Mengganti nilai lama dengan nilai baru
                print("Nilai berhasil diubah!")
                ketemu = True
                break # Keluar dari perulangan for karena data sudah ketemu
    ...
    # ----------------------------------------------------
        ...
        if len(data_mahasiswa) == 0:
            ...
            # Kita copy dulu datanya ke list baru bernama 'data_salinan'
            data_salinan = list(data_mahasiswa)
            jumlah_data = len(data_salinan)
            
            # Rumus urut manual (Bubble Sort) yang paling mudah dipahami pemula
            for i in range(jumlah_data):
                for j in range(0, jumlah_data - 1):
                    # Jika nilai yang kanan lebih besar dari yang kiri, kita tukar posisinya
    ...
    # ----------------------------------------------------
        ...
        if len(data_mahasiswa) == 0:
            ...
            total_nilai = 0
            # Tambahkan nilai satu per satu menggunakan perulangan
            for mhs in data_mahasiswa:
    ...
    # ----------------------------------------------------
        ...
        break # Perintah 'break' akan langsung menghentikan program
